...
//homework - difference between method and function//
...
strikeButton.onclick = () => {
  ...
  if (turn === 2){
    ...
    document.querySelector(`#team2-superover div:nth-child(${team2BallsFaced})`).textContent = randomElement; //string interpolation
